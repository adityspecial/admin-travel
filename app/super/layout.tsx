...
const NAV: NavEntry[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { href: '/super/offline-hotels', label: 'Offline Hotels', Icon: Building2 },
      { href: '/super/offline-hotel-bookings', label: 'Offline Hotel Requests', Icon: ClipboardList },
      { href: '/super/traveller-stories', label: 'Traveller Stories', Icon: BookOpen },
