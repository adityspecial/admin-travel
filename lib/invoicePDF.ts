...
<style>
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .logo-my { background:#E31E24; color:#fff; font-weight:900; font-size:16px; padding:3px 8px; border-radius:4px; }
  .logo-biz { font-weight:900; font-size:22px; color:#1a1a2e; }
  .logo-dot { color:#E31E24; font-weight:900; font-size:22px; }
  .logo-admin { font-weight:700; font-size:22px; color:#1a1a2e; }
  .logo-sub { font-size:11px; color:#9CA3AF; margin-top:4px; }
  .invoice-title { text-align:right; }
  .invoice-title h1 { font-size:28px; font-weight:900; color:#E31E24; letter-spacing:-0.5px; }
  ...
  .totals-row.total { border-top:2px solid #1a1a2e; border-bottom:none; padding-top:10px; margin-top:4px; font-size:16px; font-weight:900; color:#1a1a2e; }
...
<div class="page">
  ...
  <div class="footer">
    ...
    <div class="footer-right">
      Generated by AirDunia myBiz<br/>
      ${invoiceDate}
    </div>
  </div>
